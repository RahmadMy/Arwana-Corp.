...
const WorkerHarvest = () => {
  ...
  const openEditModal = (item) => {
    ...
    setFormData({
      ...
      tanggalPanen: item.tanggalPanen || '',
      jumlah: item.jumlah || '',
      tujuan: item.tujuan || '',
    })
    setShowModal(true)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        await harvestService.update(selectedId, formData)
      } else {
            ...
            >
              <div className="mb-4">
                ...
                <p className="text-gray-400 text-sm mb-2">
                  Tanggal Panen: {item.tanggalPanen}
                </p>
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
          <div className="bg-black border border-gray-700 rounded-xl w-full max-w-lg p-6">
            <h2 className="text-xl font-semibold text-white mb-4">
              {isEdit ? 'Edit Harvest' : 'Add Harvest'}
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Tujuan (Export / Lokal / Kontes)"
                className="w-full bg-black border border-gray-600 text-white px-4 py-2 rounded"
              />
